...
-- 1.	Write the query to update the age as 20 where sname is starting with 'v'.
-- update SDetails set age = 20 where sname like "v%";
-- select * from SDetails;

-- 2.	Write the query to select all the ages whose name ends with 'a'.
-- select age from SDetails where sname like "%a";

-- 3.	Write the query to delete the records from studentdetails whose sname contains 'y'.
-- delete from SDetails where sname like "%y%";
-- select * from SDetails;
